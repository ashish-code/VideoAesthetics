...
class YouTubeApi():
    ...
    def search_keyword(self):
        ...
        parser.add_argument("--r", help="define country code for search results for specific country", default="US")
        parser.add_argument("--search", help="Search Term", default="oldhollywoodtrailers")
        parser.add_argument("--max", help="number of results to return")
        parser.add_argument("--key", help="Required API key", default='AIzaSyDNBOzX3cBTUOROTBGO9FP4Gv9sGS16M3Y')
